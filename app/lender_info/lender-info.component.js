(function(angular) {
    ...
    /* @ngInject */
    function lenderInfoController($scope, $location, $timeout, appFactory, dataservice, APP_CONSTANT, API_ENDPOINT, $rootRouter) {
        var vm = this;
        ...
        function getDataFromLocal(){
            //console.log(($("#lenderInfoModal").data('bs.modal') || {}).isShown)
        ...
        function gotToTab(paneID){
            $scope.$broadcast('changePane',{paneNo: paneID});
        }
    ...
    angular.module('lsLenderApp')
        .component('lenderinfoComponent', {
            templateUrl: 'app/lender_info/lender-info.html',
