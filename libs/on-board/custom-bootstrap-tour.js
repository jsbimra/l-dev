...
(function($, window) {
  ...
  Tour = (function() {
    ...
    Tour.prototype._template = function(step, i) {
      ...
      $skip = $navigation.find('[data-role="end"]');
    ...
    Tour.prototype._reposition = function($tip, step) {
      ...
      if(step.placement === 'left'){
        tipOffset.left = $('.tour-step-background').offset().left - $tip.outerWidth() - $tip.find('.arrow').outerWidth();
      }
      
      if(step.placement === 'bottom'){
        tipOffset.left = $('.tour-step-background').offset().left;
        $tip.find('.arrow').css('left', '5%');
      }
      else if(step.placement === 'left' || step.placement === 'right'){
        tipOffset.top = $('.tour-step-background').offset().top;
        $tip.find('.arrow').css('top', '8%');
      }
